...
AOBJS=		QSufSort.o bwt_gen.o bwase.o bwaseqio.o bwtgap.o bwtaln.o bamlite.o \
			...
			bwtsw2_chain.o fastmap.o bwtpssm.o seq2pssm.o bwtsw2_pair.o \
			pssm.o bwtpssmgap.o bwtge.o
PROG=		bwa
INCLUDES=	
...
bwtpssm.o: pssm.h bwtaln.h bwtgap.h bwtpssm.h bwtpssmgap.h utils.h seq2pssm.h
...
pssm.o: pssm.h bwtaln.h
seq2pssm.o: bwtaln.h pssm.h probs.h
